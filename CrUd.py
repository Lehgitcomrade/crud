...
def add_user_window():
    ...
    email_name_entry = Entry(add_user_win)
    ...
    def add_user():
        try:
            ...
            user_data = (first_name_entry.get(), last_name_entry.get(), email_name_entry.get())
...
def delete_user_window():
    ...
    def delete_user():
        try:
            ...
            # delete user data into the database
            ...
            # create a button to add the user
    delete_button = Button(delete_user_win, text='Add User', command=delete_user)
    delete_button.pack()
...
def display_users_window():
    ...
    display_btn = Button(display_users_win, text="Display", command=view)
    display_btn.pack()
def main():
    root = Tk()
    ...
    background_image = Image.open("happyboy.jpeg")
    background_image= background_image.resize((1366,768), None)
